...
function ManagerService(router) {
  ...
  router.get('/manager/order/cook/:vendorID', function (req, res) {
    ...
    res.json(_controller["default"].popFirstOrderFromWaitingQueueToCookingQueue(vendorID));
  });
  ...
  router.get('/manager/order/:vendorID', function (req, res) {
    var vendorID = req.params.vendorID;
    var waitingOrders = vendorID in _controller["default"].waitingQueue ? _controller["default"].waitingQueue[vendorID] : [];
    var cookingOrders = vendorID in _controller["default"].cookingQueue ? _controller["default"].cookingQueue[vendorID] : [];
    var completedOrders = vendorID in _controller["default"].completedList ? _controller["default"].completedList[vendorID] : [];
    res.json({
