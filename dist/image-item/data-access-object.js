...
var database = _firebase["default"].database().ref(_configuration["default"].database["image-item"]);

var mutableFields = ['name'];
var _default = {
  /**
            ...
            case 3:
              ...
              snapshot.forEach(function (child) {
                var _child$val = child.val(),
                    ...
                    name = _child$val.name;

                var imageItem = new _model["default"](child.key, vendorID, name);
            ...
            case 3:
              ...
              snapshot.forEach(function (child) {
                var _child$val2 = child.val(),
                    ...
                    name = _child$val2.name;

                var imageItem = new _model["default"](child.key, vendorID, name);
                if (filter(imageItem)) result.push(imageItem);
              });
   ...
   */
  create: function create(imageItem) {
   ...
   * @returns {void}
   */
  modify: function modify(imageItem) {
    var data = _objectSpread({}, imageItem);
